...
<head>
	...
	<link rel="stylesheet" type="text/css" href="frontend/libs/js/Bootstrap-Image-Gallery-3.1.1/css/blueimp-gallery.min.css">
	<link rel="stylesheet" type="text/css" href="frontend/libs/js/Bootstrap-Image-Gallery-3.1.1/css/bootstrap-image-gallery.min.css">
                ...
                <ul>
                   <li class='has-sub'><a href='index.html'><span>Gallery</span></a>
                   	<ul>
	                    ...
	                    <li class='has-sub last'><a href='events.html'><span>Events</span></a></li>
                    </ul>
                    </li>
...
<?php
	...
	echo "<h1 class='page-header'>";
		echo "<a href='index.php?fb_page_id={$fb_page_id}'>Albums</a> / {$album_name}";
	echo "</h1>";
...
<script src="frontend/libs/js/bootstrap/docs-assets/js/holder.js"></script>
...
<script src="frontend/libs/js/Bootstrap-Image-Gallery-3.1.1/js/jquery.blueimp-gallery.min.js"></script>
<script src="frontend/libs/js/Bootstrap-Image-Gallery-3.1.1/js/bootstrap-image-gallery.min.js"></script>

<!-- linkify -->
<script src="frontend/libs/js/jquery.linkify.min.js"></script>
